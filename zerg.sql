...
-- ----------------------------
BEGIN;
INSERT INTO `order` VALUES (106, 'C725634845425138', 1, NULL, 1564063484, 0.01, 1, 'http://zerg.demo.com/images/product-dryfruit@4.png', '冬木红枣 500克', 1, 1564063484, '[{\"id\":9,\"haveStock\":true,\"counts\":1,\"price\":\"0.01\",\"name\":\"\\u51ac\\u6728\\u7ea2\\u67a3 500\\u514b\",\"totalPrice\":0.01,\"main_img_url\":\"http:\\/\\/zerg.demo.com\\/images\\/product-dryfruit@4.png\"}]', '{\"name\":\"\\u5f20\\u4e09\",\"mobile\":\"020-81167888\",\"province\":\"\\u5e7f\\u4e1c\\u7701\",\"city\":\"\\u5e7f\\u5dde\\u5e02\",\"country\":\"\\u6d77\\u73e0\\u533a\",\"detail\":\"\\u65b0\\u6e2f\\u4e2d\\u8def397\\u53f7\",\"update_time\":\"1970-01-01 08:00:00\"}', NULL);
INSERT INTO `order` VALUES (107, 'C726028750099448', 1, NULL, 1564102875, 0.01, 1, 'http://zerg.demo.com/images/product-dryfruit@3.png', '夏日芒果 3个', 1, 1564102875, '[{\"id\":8,\"haveStock\":true,\"counts\":1,\"price\":\"0.01\",\"name\":\"\\u590f\\u65e5\\u8292\\u679c 3\\u4e2a\",\"totalPrice\":0.01,\"main_img_url\":\"http:\\/\\/zerg.demo.com\\/images\\/product-dryfruit@3.png\"}]', '{\"name\":\"\\u5f20\\u4e09\",\"mobile\":\"020-81167888\",\"province\":\"\\u5e7f\\u4e1c\\u7701\",\"city\":\"\\u5e7f\\u5dde\\u5e02\",\"country\":\"\\u6d77\\u73e0\\u533a\",\"detail\":\"\\u65b0\\u6e2f\\u4e2d\\u8def397\\u53f7\",\"update_time\":\"1970-01-01 08:00:00\"}', NULL);
COMMIT;
...
-- ----------------------------
BEGIN;
INSERT INTO `order_product` VALUES (107, 8, 1, NULL, NULL);
INSERT INTO `order_product` VALUES (106, 9, 1, NULL, NULL);
COMMIT;
...
INSERT INTO `product` VALUES (5, '春生龙眼 500克', 0.01, 1111, NULL, 2, '/product-dryfruit@2.png', 1, NULL, NULL, NULL, 33);
...
-- ----------------------------
BEGIN;
INSERT INTO `user` VALUES (1, 'oyDr25U1vKryVZtGirFAx8cyuF4U', NULL, NULL, NULL, NULL, NULL);
COMMIT;
...
-- ----------------------------
BEGIN;
INSERT INTO `user_address` VALUES (2, '张三', '020-81167888', '广东省', '广州市', '海珠区', '新港中路397号', NULL, 1, NULL);
COMMIT;
